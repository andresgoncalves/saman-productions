...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        reviewChaptersCN = new javax.swing.JLabel();
        ...
        jLabel25.setText("Cantidad de escenarios existentes:");
        StarChannel.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, -1, -1));

        jLabel26.setForeground(new java.awt.Color(0, 0, 0));
        jLabel26.setText("Cantidad máxima de escenarios:");
        ...
        jLabel28.setText("Cantidad de animaciomes existentes:");
        StarChannel.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, -1, -1));

        jLabel29.setForeground(new java.awt.Color(0, 0, 0));
        jLabel29.setText("Cantidad máxima de animaciomes:");
        ...
        StarChannel.add(capitulosStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, 50, 20));
        StarChannel.add(SceneChapters, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 50, 20));
        StarChannel.add(DoblajeChapters, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 120, 40, 20));
        StarChannel.add(AnimatorChapters, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 280, 50, 20));
        StarChannel.add(plotTwistChapters, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, 40, 20));
        StarChannel.add(deadLineSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 370, 50, 20));
        StarChannel.add(pmStatusSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 450, 150, 20));
        StarChannel.add(faultsPMStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 480, 80, 20));
        StarChannel.add(directorStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 460, 150, 20));
        StarChannel.add(moneyDiscountPMSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 510, 160, 20));
        StarChannel.add(ingresosSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 570, 100, 20));

        maxStarScreenWriter.setText(String.valueOf(Screenwriter.DRIVE_SIZE));
        StarChannel.add(maxStarScreenWriter, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 40, 20));

        maxSceneStar.setText(String.valueOf(SetDesigner.DRIVE_SIZE));
        StarChannel.add(maxSceneStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 200, 70, 20));

        maxDoblajeStar.setText(String.valueOf(VoiceActor.DRIVE_SIZE));
        StarChannel.add(maxDoblajeStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 150, 70, 20));

        maxAnimatorStar.setText(String.valueOf(Animator.DRIVE_SIZE));
        StarChannel.add(maxAnimatorStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 80, 20));

        maxPlotTwistStar.setText(String.valueOf(PlotTwistWriter.DRIVE_SIZE));
        StarChannel.add(maxPlotTwistStar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 270, 60, 20));
        StarChannel.add(reviewChaptersSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 370, 70, 20));
        StarChannel.add(publishedChaptersSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 370, 50, 20));
        StarChannel.add(costosSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 570, 100, 20));
        StarChannel.add(utilidadesSC, new org.netbeans.lib.awtextra.AbsoluteConstraints(483, 570, 120, 20));
        ...
        jLabel6.setText("Capacidad máxima de escenarios:");
        CapitulosDrive.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 230, -1));

        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Cantidad de escenarios existentes:");
        CapitulosDrive.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 230, -1));

        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("Capacidad máxima de guiones:");
        ...
        jLabel10.setText("Cantidad de guiones existentes:");
        ...
        jLabel12.setText("Cantidad de animaciones existentes:");
        CapitulosDrive.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 220, -1));

        jLabel13.setForeground(new java.awt.Color(0, 0, 0));
        jLabel13.setText("Capacidad máxima de animaciones:");
        CapitulosDrive.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 220, -1));
        ...
        CapitulosDrive.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 220, 140, 20));

        jLabel18.setForeground(new java.awt.Color(0, 0, 0));
        jLabel18.setText("Cantidad de plot twists existentes:");
        CapitulosDrive.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, 220, -1));

        jLabel19.setForeground(new java.awt.Color(0, 0, 0));
        jLabel19.setText("Capacidad máxima de plot twists:");
        CapitulosDrive.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, 220, -1));
        ...
        jLabel64.setText("Utilidad:");
        CapitulosDrive.add(jLabel64, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 570, -1, -1));
        CapitulosDrive.add(chaptersScreenWriterCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, 80, 20));
        CapitulosDrive.add(chapterVoiceCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 130, 90, 20));
        CapitulosDrive.add(chaptersPTWriterCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, 90, 20));
        CapitulosDrive.add(chaptersSceneCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 90, 20));
        CapitulosDrive.add(chaptersAnimatorCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 280, 60, 20));
        CapitulosDrive.add(deadLineCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 370, 70, 20));
        CapitulosDrive.add(pmStatusCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 450, 150, 20));
        CapitulosDrive.add(faultsPMCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 480, 160, 20));
        CapitulosDrive.add(directorCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 460, 160, 20));
        CapitulosDrive.add(discountMoneyPMCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 510, 160, 20));

        screenwriterDriveSizeCN.setText(String.valueOf(Screenwriter.DRIVE_SIZE));
        CapitulosDrive.add(screenwriterDriveSizeCN,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 90, 20));

        maxSceneCN.setText(String.valueOf(SetDesigner.DRIVE_SIZE));
        CapitulosDrive.add(maxSceneCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, 70, 20));

        maxDoblajeCN.setText(String.valueOf(VoiceActor.DRIVE_SIZE));
        CapitulosDrive.add(maxDoblajeCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 160, 80, 20));

        maxPTCN.setText(String.valueOf(PlotTwistWriter.DRIVE_SIZE));
        CapitulosDrive.add(maxPTCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 270, 90, 20));

        maxAnimatorCN.setText(String.valueOf(Animator.DRIVE_SIZE));
        CapitulosDrive.add(maxAnimatorCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 310, 70, 20));
        CapitulosDrive.add(costosCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 570, 100, 20));
        CapitulosDrive.add(utilidadesCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(483, 570, 130, 20));
        CapitulosDrive.add(ingresosCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 570, 100, 20));
        CapitulosDrive.add(publishedChaptersCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 370, 80, 20));
        CapitulosDrive.add(reviewChaptersCN, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 370, 80, 20));
    ...
    public void setReviewChaptersCN(String texto) {
        reviewChaptersCN.setText(texto);
    }
    ...
    private void actualizeDataActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_actualizeDataActionPerformed
        if (guionistas != null && designers != null && animadores != null && doblaje != null && plotTwist != null
            ...
            JOptionPane.showMessageDialog(this, "Error: Los campos no pueden estar vac�os.", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JLabel reviewChaptersCN;
